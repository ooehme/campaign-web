...
import { assignedTeamId } from '../utils/assignment'
...
const assignmentTeamCount = (assignments: Assignment[], teamId: number) =>
  assignments.filter((assignment) => assignedTeamId(assignment) === teamId && assignment.status !== 'completed' && assignment.status !== 'cancelled').length
